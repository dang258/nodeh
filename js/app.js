$(document).ready(function () {
  ...
  //春节倒计时
  var starttime = new Date("2023/1/01");
  setInterval(function () {
    ...
    var syday =
      ...
      "秒";
    $(".time").html(
      "<p>距离2023年还有</p>" + "<p><span>" + day + "</span>" + "天</p>"
    );
    $(".sydate").html(syday);
  }, 1000);
  ...
  var mess =
    "<span>好看(♥∀♥)！</span><span class='B-span2'>过的好快</span><span>不错不错</span>";
  $(".Barrage").append(mess);
  ...
  $(".buts").click(function () {
    ...
    if (!mes) {
      // alert("你还没输入内容呢!")
      var Tipss = "<div class='Tipss'>亲爱的，您还没输入内容呢</div>";
      $("body").append(Tipss);
      setTimeout(function () {
        $(".Tipss").remove();
      }, 1500);
